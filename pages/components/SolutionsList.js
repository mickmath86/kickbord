...
const content = [
    {
        ...
        subConent: [
            {
                1: [IconOne, "Competetive Exchange Rates", "Lorem Ipsum"], 
                2: [IconThree, "No Hidden Fees", "Lorem Ipsum"]
            }
        ]
            ...
            <div className="relative">
              <div className="flex place-items-start">        
                  ...
                  <div>
                      ...
                      <dl className="mt-10 space-y-10">
                          {item.subConent.map((thing) => (
                          <div key={item.id} className="relative">
                              <dt>
                                  <div className="absolute flex items-center justify-center h-12 w-12 rounded-md bg-orange-500 text-white">
                                  {/* <thing[0] className="h-6 w-6" aria-hidden="true" /> */}
                                  </div>
                                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">{thing[2]}</p>
                              </dt>
                              <dd className="mt-2 ml-16 text-base text-gray-500">{thing[3]}</dd>
                          </div>
                          ))}
                      </dl>
                  </div>
