        ...
        <div className="container mx-auto max-w-6xl flex-col bg-grey-100">
            {solutions.map((item) => (
                <div key={item.id} className=" flex text-sky-200 cursor-pointer rounded-md items-center p-6 group hover:bg-gray-800 backdrop-blur-m transition ease-in-out duration-200">
                    ...
                    <div className="ml-5">
                        <h1 className="text-2xl mt-5 font-bold group-hover:text-sky-500 ease-in-out duration-300 lg:text-5xl ">{item.name}</h1>
                        <div className="flex items-center mt-2">
                            ...
                            <ArrowNarrowRightIcon className="text-gray-900 w-8 group-hover:text-sky-500 animate-pulse ml-4 " />
                            {/* <div className="hidden group-hover:inline px-4 py-2 ml-2 rounded bg-white text-black hover:bg-sky-500">Learn More</div> */}
                        </div>
