...
const StepperContent = ({ step }) => {
  return (
    <div
      className="my-4 flex min-h-[400px] w-full flex-col items-center justify-center overflow-hidden rounded-2xl bg-muted p-6 text-center">
      <motion.div
        key={step.imageSrc}
      ...
      <p
        className="mt-6 px-10 text-base leading-snug font-normal tracking-tight text-muted-foreground">
        {step.description}
      </p>
    </div>
  );
...
const NavButtons = ({ handlePrev, handleNext }) => (
...
const Timeline7 = () => {
  ...
  return (
    <section className="bg-none py-32">
      <div
        className="container flex max-w-2xl flex-col items-center gap-10 md:gap-0">
        <h1
          className="mb-10 text-center text-white text-6xl font-bold tracking-tighter text-foreground">
          Our Process
        </h1>
